...
<section>
    <article>
        <div class="single">
            <div class="container">
                <div class="row <?php if($options['single']== 'option-3'){ echo 'justify-content-md-center';} ?>">
                    <?php
                    if($options['single'] == 'option-1'){
                        ?>
                        <div class="col-md-3 order-md-1">

                            <?php dynamic_sidebar('home_sidebar_4'); ?>
                        </div>
                            ...
                            <div class="single-post">
                                <div class="single-post-img">
                                    ...
                                    <div class="more">
                                        ...
                                        <a onclick="window.open(&quot;<?php echo bloginfo('url') . '/&print?id='. $post->ID; ?>&quot;, &quot;printwin&quot;,&quot;left=200,top=200,width=820,height=550,toolbar=1,resizable=0,status=0,scrollbars=1&quot;);">
                                ...
                                <div class="single-post-content">
                                    <div class="title">
                                        ...
                                        if(get_the_excerpt()){
                                            ...
                                            echo '<h2><strong>'.get_the_excerpt().'</strong></h2>';
                                    ...
                                    <div class="content">
                                        ...
                                        <nav class="share col-12" id="sharee">
                        ...
                        <?php
                    }elseif ($options['single'] == 'option-2'){
                        ?>
                        <div class="col-md-9">
                            <div class="single-post">
                                <div class="single-post-img">
